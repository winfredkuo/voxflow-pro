            ...
            {user ? (
              <div className="flex items-center gap-4">
                <button 
                  ...
                  className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-amber-50 rounded-full border border-amber-100 hover:bg-amber-100 transition-colors"
                >
                  <Coins size={14} className="text-amber-600" />
                  <span className="text-xs font-bold text-amber-700">剩餘: {quota} 分鐘</span>
                  <div className="w-4 h-4 bg-amber-600 text-white rounded-full flex items-center justify-center text-[10px]">+</div>
                </button>
